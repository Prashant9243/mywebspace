        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Monthly / Yearly Sales Report</h3>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="row">
                    <form class="form-inline" method="POST" action="<?php echo base_url();?>user/Manage_reports/monthly_sales_report">
