...
/**/
    ...
    function check_old_pro($product_id)
    {
    ...
    function check_retailer($retailer_mobile)
    {
        $this->db->select('id');
        $this->db->where('contact_no',$retailer_mobile);
