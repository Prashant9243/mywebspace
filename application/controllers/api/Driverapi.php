...
header("Access-Control-Allow-Origin: *");
  ...
  class Driverapi extends REST_Controller {
      ...
      $driver_id = $getdetails->{'driver_id'};
        ...
        if(!empty($getridedetails))
        {
          ...
          $ridedetails[] =  array(
                  ...
                  'driverfees'    => round($getridedetailsi->driverfees,2),
        ...
        {
          $totalwalletsum = $totalwalletsums; 
        }
        else
        {
          $totalwalletsum ='0.00';
        ...
        {
          $this->response(['responsecode' => 1,'totalwalletsum' => round($totalwalletsum,2),'ridedetails'=>$ridedetails,'response' => 'Success!'], REST_Controller::HTTP_OK);
        }
    }
